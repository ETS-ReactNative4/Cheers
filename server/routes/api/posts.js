          ...
          async function (err, result) {
            ...
            connection.query(
              ...
              async function (err, result) {
                ...
                //       // });
                //     }
                //     // Create objects to insert into uses
                //     let firstInsert = result.insertId;
                //     let uses = [];
                //     for (let i = 0; i < ingredients.length; i++) {
                //       let innerArray = [recipeId, firstInsert + i];
                //       uses.push(innerArray);
                //     }
                //     connection.query(
                //       "INSERT IGNORE INTO uses(recipe_id, ingredient_id) VALUES ?",
                //       [uses],
                //       function (err, result) {
                //         if (err) {
                //           connection.rollback(function () {
